...
export class CartService {
  ...
  async updateCart(userId: string, cart: CartEntity): Promise<{ cart: CartEntity, totalPrice: number}> {
  ...
  async createCart(userId: string): Promise<{ cart: CartEntity, totalPrice: number}> {
