...
export class Migration20230925155314 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "order" ("id" uuid not null, "user_id" varchar(255) not null, "cart_id" varchar(255) not null, "items" jsonb not null, "payment" jsonb not null, "delivery" jsonb not null, "comments" varchar(255) not null, "status" smallint not null, "total" int not null, constraint "order_pkey" primary key ("id"));');
    ...
    this.addSql('create table "cart_item" ("id" uuid not null, "count" int not null, "product_id" varchar(255) not null, "cart_id" uuid not null, constraint "cart_item_pkey" primary key ("id"));');
